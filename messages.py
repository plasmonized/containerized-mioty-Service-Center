...
def build_attach_request_legacy(sensor: dict[str, Any], opID: int) -> dict[str, object]:
    return {
        "command": "attPrp",
        "opId": opID,
...
def build_detach_request_legacy(eui: str, opID: int) -> dict[str, object]:
...
def build_status_request_legacy(opID: int) -> dict[str, object]:
...
def build_detach_response_legacy(opID: int) -> dict[str, object]:
